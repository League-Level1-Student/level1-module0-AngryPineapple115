...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		initializeGui(400, 400);
		// 4. Ask the user who this person is and store their answer
		String guessOne = JOptionPane.showInputDialog("Who is this person?");

		// 5. Check their answer. If they guessed correctly:
		// -- Tell them they are right and increase the score by 1
		if (guessOne.equalsIgnoreCase("Arnold")) {
			score = score + 1;
		}
		// 6. Otherwise:
		// -- Tell them they are wrong and who the person is
		else {
			JOptionPane.showMessageDialog(null, "No, the person was Arnold.");
		}
	...
	private void initializeGui(int i, int j) {
		initializeImageList();
